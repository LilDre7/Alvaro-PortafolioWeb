  ...
  return (
    <div className="w-full flex items-center justify-center p-4 -mt-32 sm:-mt-56">
      <div className="relative w-[95%] max-w-[360px] sm:max-w-[400px] md:max-w-[500px] aspect-square">
        {/* Center Hub */}
        <motion.div
          className="absolute left-1/2 top-1/2 w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 -ml-5 -mt-5 sm:-ml-6 sm:-mt-6 md:-ml-7 md:-mt-7 z-50 bg-white rounded-full shadow-md flex items-center justify-center"
          animate={{
            scale: [1, 1.05, 1],
            rotate: [0, 360],
          }}
        ...
        {services.map((service, index) => {
          ...
          return (
            <div key={service.name}>
              ...
              {/* Service Icon */}
              <motion.div
                className="absolute w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 -ml-5 -mt-5 sm:-ml-6 sm:-mt-6 md:-ml-7 md:-mt-7 bg-white rounded-full shadow-lg flex items-center justify-center"
                style={{
                  left: `calc(50% + ${x}px)`,
                  top: `calc(50% + ${y}px)`,
                }}
